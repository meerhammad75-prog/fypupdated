...
class _DevicesScreenState extends State<DevicesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final subTextColor = isDark ? Colors.grey.shade400 : Colors.indigo.shade700;
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError || !snapshot.hasData || snapshot.data?.snapshot.value == null) {
            return Center(child: Text("Connecting to Device...", style: TextStyle(color: textColor)));
          }
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.access_time, size: 18, color: isDark ? Colors.grey : Colors.indigo),
                          ...
                          Text(
                            isSchedActive
                                ...
                                : "Tap to set schedule",
                            style: TextStyle(
                              color: isDark ? Colors.grey.shade300 : Colors.indigo.shade800,
                              fontWeight: FontWeight.w600,
                            ),
                          ),
                        ],
                      ),
                      Icon(Icons.edit, size: 16, color: isDark ? Colors.grey : Colors.indigo.withOpacity(0.5)),
                    ],
                  ),
                ),
              )
