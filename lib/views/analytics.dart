                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: _buildSummaryCard('Current Load', '${(currentPowerWatts/1000).toStringAsFixed(2)} kW', Colors.orange)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildSummaryCard('Total Energy', '${totalLifeTimeEnergy.toStringAsFixed(2)} kWh', Colors.blue)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildSummaryCard('Est. Bill', 'Rs ${data["bill"] ?? "0"}', Colors.green)),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: chartData.isEmpty
                        ? const Center(child: Text("No Active Devices"))
                        : BarChart(
                      BarChartData(
