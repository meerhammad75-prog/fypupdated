...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // Theme Colors
  final Color _cyanColor = const Color(0xff23ABC3);
  final Color _darkCyan = const Color(0xff1A8599);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Settings", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 24, letterSpacing: 0.5)),
          centerTitle: true,
            ...
            children: [
              ...
              _buildPremiumCard([
                _buildNavTile(
                  ...
                  gradient: [const Color(0xff23ABC3), const Color(0xff23ABC3).withOpacity(0.6)],
                  ...
                  return ListTile(
                    ...
                    title: Text(
                        ...
                        style: TextStyle(
                            ...
                            color: isSelected ? _cyanColor : Colors.black87
                        )
                    ),
                    trailing: isSelected ? Icon(Icons.check_circle, color: _cyanColor) : null,
                    onTap: () async {
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: _cyanColor.withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
                      child: Icon(Icons.wifi_find_rounded, color: _cyanColor, size: 28),
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide(color: _cyanColor, width: 2)),
